...
loop(vOld,
   shr0_xp(r,a)$xpFlag(r,a)  = pxp0(r,a)*xpx0(r,a)/(uc0(r,a)*xpv0(r,a)) ;
   ...
   shr0_ksw(r,a)$kFlag(r,a) = pksw0(r,a)*ksw0(r,a) / (pkf0(r,a)*kf0(r,a)) ;
   loop(nrs,
      shr0_nrs(r,a)$xfFlag(r,nrs,a) = pfp0(r,nrs,a)*xf0(r,nrs,a)/(pkf0(r,a)*kf0(r,a)) ;
   ) ;
   alpha_ksw(r,a,v,t)       = 1 ;
   alpha_nrs(r,a,v,t)       = 1 ;
...
alphatt(r,img,t)$xttFlag(r,img)  = pdt0(r,img)*xtt0(r,img)/(ptmg0(img)*xtmg0(img)) ;
...
emiTotETS.l(r,em,aets,t)$emiTotETS0(r,em,aets) = 1 ;
